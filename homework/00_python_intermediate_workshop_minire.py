# -*- coding: utf-8 -*-
"""
Created on Mon Sep 26 17:17:54 2016
...
'''
family = ["Pete", "Janet", "Erica", "Barb", "Becca"]
print family [4]
print len( family [0])
family [3] = "Babbs"
print family 
print family.append("Lyla")
print family[5].lower()
...
for people in family :
    family = ["Pete", "Janet", "Erica", "Barb", "Becca", "Lyla"]
    print sorted(family, len(people))
...
def upper(x):
    upper_letters = []
    for items in x:
        upper_letters.append(items.upper())    
    print upper_letters 
...
def up(n):
    sliced_upper = []
    for items in n:
        sliced_upper.append(items.upper())
    print sliced_upper 
