...
rfreg = RandomForestRegressor(n_estimators=80, max_features=2, oob_score=True, random_state=1)
rfreg.fit(X, y)
...
rfreg = RandomForestRegressor(n_estimators=40, max_features=5, random_state=1)
