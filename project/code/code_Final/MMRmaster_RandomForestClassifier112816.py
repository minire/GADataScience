...
feature_cols = ['AOD_FMLE', 'attend%', 'GNI',  'cell_Subscription%', 'EDFMLE_MLE%', 'ABR%'] # 'prenat%', 'homicide100K', 'homicide100K', 'cell_Subscription%', 'contraceptives%','ED_FMLE%', 'Abortion_scale', 'contraceptives%',  'contraRegMed', 'contraRegFill', 
...
#print 'Null Accuracy:'
#null = mother.MMRClassifier.value_counts()/len(mother)
#print null.head()
